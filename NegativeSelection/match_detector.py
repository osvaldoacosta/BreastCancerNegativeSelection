...
def match_detector(trackers, samples, distance_metric=eucdist, verbose=0, test_size=0):
    ...
    if verbose == 1:
        ...
        nonself_qty = np.sum(nonself > 0)
        print("Number of nonself samples detected: ", nonself_qty)
        if(test_size > 0):
            print("Accuracy: ", nonself_qty/test_size)
